    ...
    <Badge count={check ? <Tickcircle className="fill-[#0F6EFF]" /> : 0}>
      ...
      >
        <div className="flex gap-[17px] items-center">
          <Avatar
            shape="circle"
            src="https://www.shutterstock.com/shutterstock/photos/289654529/display_1500/stock-photo-professional-actor-ready-for-a-shoot-portrait-of-a-handsome-man-a-ready-to-film-a-new-scene-289654529.jpg"
            alt="thumbnail"
            size="large"
          />
