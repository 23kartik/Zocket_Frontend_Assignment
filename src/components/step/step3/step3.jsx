...
function Step3({ page, setPage }) {
          ...
          <div className="flex gap-2">
            ...
            <div className="flex flex-col">
              <div>
                ...
                >
                  <button
                    className={`rounded-[200px] w-[120px] h-[39px] text-[14px] font-medium leading-8  border-[1.5px] ${
                      switch1 === true
              ...
              <div className="mt-[45px]">
                ...
                <div className="mt-4">
                  <div className="flex flex-col">
                    ...
                    <div className="pt-2">
                      <Input
                        className="w-[100%] h-[50px] rounded-[10px] border-[#E9E9E9] border-[1.5px] text-[16px] font-normal"
                ...
                <div className="mt-4">
                  ...
                  <div className="flex mt-1 justify-between">
                    <p className="text-[#606060] text-[12px] font-medium">0</p>
  ...
  onClick={() => (page === 3 ? setPage(0) : setPage(page + 1))}
  className="mt-16 mr-28 bg-[#0F6EFF] h-12 w-60 absolute right-0 text-white-100 text-[16px] font-medium leading-6 hover-bg-white-100"
>
  Continue
</Button>
</div>
